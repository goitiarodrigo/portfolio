      ...
      <div className="coverPhoto">
        ...
        <div className="myProfileContainer">
          <div className="containerChildren">
            ...
            <div className="myPhoto" style={{backgroundImage: 'url("https://i.postimg.cc/T3q3bQzx/Sin-t-tulo-1600-x-1080-px-1200-x-1080-px.png")'}}></div>
          </div>  
